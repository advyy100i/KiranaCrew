# KiranaCrew: technical reference

> Setup, layout, commands and switches. For the story of what this is and why, read the [top-level README](../README.md).
...
<img width="1774" height="887" alt="KiranaCrew architecture" src="https://github.com/user-attachments/assets/6b7aa8df-d5a9-4204-8690-89403de6ee9e" />
...
| `frontend/` | Flutter web dashboard (226 lines), served at `/dashboard` after `flutter build web --base-href /dashboard/` |
...
Numbers, per parser mode and dataset, are in [`eval_report.md`](eval_report.md). The metric that matters
...
kept out of bookkeeping: [`decisions/`](decisions/).
